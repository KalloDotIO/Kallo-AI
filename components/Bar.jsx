...
export default function Bar({stroke='#000000', className='', title='', onClick = () => {}}) {
  return (
   
    
    <svg onClick={onClick} title={title} className={className} width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
